...
<script>
  ...
  <section id="home" class="relative h-screen w-full overflow-hidden">
    ...
    <div class="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-center text-center text-white">
      ...
      <p class="text-lg">Innovative Architecture for a Modern World</p>
    </div>
  </section>
...
<!-- Clients Section (3-row horizontal marquee) -->
<!-- Clients Section -->
...
<section id="projects" class="py-20 bg-gray-50">
  ...
  <div id="album-view" class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6 max-w-7xl mx-auto px-6">
    ...
    <div class="album-card bg-white shadow-lg rounded-lg overflow-hidden cursor-pointer" data-album="bateeq">
      <img src="https://images.unsplash.com/photo-1490481651871-ab68de25d43d?auto=format&fit=crop&w=800&q=80" class="w-full h-40 object-cover">
...
<!-- Album-specific Lightbox (unique IDs so it doesn't collide with other lightboxes) -->
...
<script>
  ...
  /* album lightbox functions (isolated names) */
...
<section id="contact" class="py-20 bg-gray-100">
  ...
  <!-- Floating Contact Radial Menu -->
<div class="floating-menu">
  <!-- Main Toggle Button -->
  <button id="menu-toggle" class="float-btn main">
    <i id="menu-icon" class="fas fa-comment-dots"></i>
  </button>

  <!-- Contact Icons -->
  <div id="radial-menu" class="radial-menu">
    <a href="https://wa.me/6287760817047?text=Hello%20Prosphera Home%2C%20I%20would%20like%20to%20know%20more%20about%20your%20services." target="_blank" class="float-btn whatsapp">
      <i class="fab fa-whatsapp"></i>
    </a>
    <a href="https://instagram.com/prosphera.home" target="_blank" class="float-btn instagram">
      <i class="fab fa-instagram"></i>
    </a>
    <a href="https://tiktok.com/@prosphera.home" target="_blank" class="float-btn tiktok">
...
<style>
  ...
  .main { background-color: #4caf50; } /* Green toggle */
  .whatsapp { background-color: #25d366; }
  .instagram { background: radial-gradient(circle at 30% 107%, #fdf497 0%, #fd5949 45%, #d6249f 60%, #285AEB 90%); }
  .tiktok { background-color: #000; }
  ...
  .radial-menu {
    ...
    top: 100%;
    left: 0%;
    transform: translate(-50%, -50%); /* center on main button */
    width: 0;
    height: 0;
  }
  .radial-menu a {
